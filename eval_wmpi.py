    ...
    for ro0 in ro0_l:
      ...
      for scher in scher_l:
        if scher._type == 'Scher_wMultiplicativeExpansion' and scher.sching_m['type'] == 'expand_if_totaldemand_leq' and scher.sching_m['threshold'] == -1:
          d = redsmall_optimal_d(ro0, N, Cap, k, r, b, sinfo_m['lifetime_rv'].a, a, alpha_gen, red)
  ...
  for ro0 in ro0_l:
    ...
    if rank == 0:
      ...
      for i, scher in enumerate(scher_l):
        ...
        if scher._type == 'Scher_wMultiplicativeExpansion' and scher.sching_m['type'] == 'expand_if_totaldemand_leq' and scher.sching_m['threshold'] == -1:
          scher._id = 'd={}'.format(redsmall_optimal_d(ro0, N, Cap, k, r, b, sinfo_m['lifetime_rv'].a, a, alpha_gen, red) )
      ...
      while True:
        ...
        if scher._type == 'RLScher':
          ...
          scher.sching_m['threshold'] = redsmall_optimal_d(ro0, N, Cap, k, r, b, sinfo_m['lifetime_rv'].a, a, alpha_gen, red)
