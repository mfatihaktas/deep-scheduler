...
#SBATCH --nodes=21              # Number of nodes you require
#SBATCH --ntasks=21             # Total # of tasks across all nodes
...
srun --mpi=pmi2 python3 /home/mfa51/deep-scheduler/learning_howtorep_wmpi.py
